...
function M.setup(colors, _)
  ...
  hl("NvimTreeEndOfBuffer",     { fg = colors.bg,      bg = colors.bg })
  hl("NvimTreeCursorLine",      { bg = colors.cursor_line })
  hl("NvimTreeCursorColumn",    { bg = colors.cursor_line })
  hl("NvimTreeLineNr",          { fg = colors.line_nr, bg = colors.bg })
  hl("NvimTreeStatuslineNc",    { fg = colors.bg,      bg = colors.bg })
  hl("NvimTreeSignColumn",      { fg = colors.bg,      bg = colors.bg })
  hl("NvimTreeWinSeparator",    { fg = colors.popup_border, bg = colors.bg })
  hl("NvimTreeVertSplit",       { fg = colors.popup_border, bg = colors.bg })
